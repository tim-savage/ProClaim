...
class VisualizationReversionTask implements Runnable {
	...
	VisualizationReversionTask(Player player, PlayerState playerState, Visualization visualization) {
	...
	public void run() {
	    ...
	    if(playerState.getCurrentVisualization() != visualization) return;
