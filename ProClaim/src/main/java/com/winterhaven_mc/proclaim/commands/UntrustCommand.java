...
final class UntrustCommand implements CommandExecutor, TabCompleter {
	 ...
	 */
	UntrustCommand(final PluginMain plugin) {
	...
	/**
	 * Remove all trust for a claim from another player
	 */
	@Override
	public final boolean onCommand(final CommandSender sender, final Command command, 
		...
		// remove claim permission for player
		claim.removePlayerPermission(recipientUUID);
		
		// send player success message
		plugin.messageManager.sendPlayerMessage(sender, "COMMAND_SUCCESS_UNTRUST",claim);
